...
-- CreateEnum
CREATE TYPE "FrameModel" AS ENUM ('iphonex', 'iphone11', 'iphone12', 'iphone13', 'iphone14', 'iphone15');

-- CreateEnum
CREATE TYPE "FrameMaterial" AS ENUM ('WOOK', 'METAL', 'PLASTIC', 'COMPOSITE');

-- CreateEnum
CREATE TYPE "FrameStyle" AS ENUM ('CLASSIC', 'MODERN', 'RUSTIC', 'INDUSTRIAL');

-- CreateEnum
CREATE TYPE "FrameColor" AS ENUM ('black', 'blue', 'rose');
