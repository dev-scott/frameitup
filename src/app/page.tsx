          ...
          className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Frame Your{" "}
                <span className="bg-primary px-2 text-white">Memories</span>{" "}
                Your Way
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Your favorite moments deserve more than just a digital screen.
                At{" "}
                <span className="font-semibold underline underline-offset">
                  {" "}
                  FrameitUp{" "}
                </span>
                , we bring your photos to life with high-quality, fully
                customizable picture frames designed to suit your style.
              </p>
        ...
        <MaxWidthWrapper className="">
          <div className="flex flex-col items-start gap-4">
            <div className="  w-full flex justify-between items-end">
              <div >
                <h1 className="text-start font-bold text-gray-900 leading-tight">
                  All our product
                </h1>
                <p className="text-start  font-normal leading-tight tracking-wide ">
                  Discover our new product
                </p>
              </div>
              <div>
                <Button className="text-white hover:bg-primary hover:opacity-85 ">
                  Go to market
                </Button>
              </div>
            </div>
            ...
            <div className="w-full mt-2  flex flex-row items-start space-x-3">
