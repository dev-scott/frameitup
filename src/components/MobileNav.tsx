                  ...
                  <div className="grid grid-cols-2 gap-y-10 gap-x-4">
                    {PRODUCT_CATEGORIES[0].featured.map((item) => (
                      <div key={item.name} className="group relative text-sm">
                        <div
                          className={cn(
                            "relative aspect-square overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75",
                            // {
                            //   "frame-wood": category.value == "wood_frame",
                            //   "frame-plastic":
                            //     category.value == "plastic_frame",
                            //   "frame-border":
                            //     category.value == "bordered_frame",
                            // },
                          )}
                        >
                          <Image
