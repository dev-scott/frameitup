...
export const translations = {
  en: {
    ...
    footer: {
      ...
      copyright: '© 2025 FrameItUp. All rights reserved. Crafted with ♥ for art lovers.',
  ...
  fr: {
    ...
    footer: {
      ...
      copyright: '© 2025 FrameItUp. Tous droits réservés. Conçu avec ♥ pour les amoureux de l\'art.',
