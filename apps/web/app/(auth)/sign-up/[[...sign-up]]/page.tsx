...
export default function SignUpPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-6 pt-24 pb-16 relative overflow-hidden">
      ...
      <div className="absolute top-32 right-1/4 w-96 h-96 bg-[var(--brand-400)] opacity-5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-24 left-1/4 w-72 h-72 bg-[var(--brand-600)] opacity-8 rounded-full blur-2xl pointer-events-none" />
